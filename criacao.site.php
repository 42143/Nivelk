                ...
                <div class="Screen screen1">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col block">
                                <?php
                                    if(isset($_GET["criacao"])){
                                        if($_GET["criacao"] == "site"){
                                            
                                            echo "<h2>CRIAÇÃO DE SITE</h2>";
                            ...
                            <div class="w-100"></div>
                            <div class="col block">
                                <a href="http://nivelk.com.br/criacao.site.php?criacao=site" class="btn btn-outline-primary btn-block btn-lg <?php echo $logo; ?>" role="button" aria-pressed="true">
                                    CRIAÇÃO DE SITE
                                </a>
                            </div>
                            <div class="col block">
                                <a href="http://nivelk.com.br/criacao.site.php?criacao=loja" class="btn btn-outline-primary btn-block btn-lg  <?php echo $visual; ?>" role="button" aria-pressed="true">
                                    LOJA VIRTUAL
                                </a>
                            </div>
                            <div class="col block">
                                <a href="http://nivelk.com.br/criacao.site.php?criacao=landing" class="btn btn-outline-primary btn-block btn-lg  <?php echo $impressao; ?>" role="button" aria-pressed="true">
                                     LANDING PAGE
                                </a>
                            </div>
                        </div>
