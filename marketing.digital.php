...
<html lang="br" >
	<head>
		...
		<!--SASS-->
		<link rel="stylesheet" href="sass/pages/marketing.css"/>
        <link rel="stylesheet" href="sass/componentes/font-awesome-4.7.0/css/font-awesome.min.css"/>
		<title>Marketing Digital | Nivelk</title>
        <script>
            $(function(){
                ...
                <div class="Screen screen1">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col block">
                                <?php
                                    if(isset($_GET["marketing"])){
                                        if($_GET["marketing"] == "mdp"){
                                            
                                            echo "<h2>MARKETING DE POSICIONAMENTO</h2>";
                                            $b1 = 'disabled active';
                                        ...
                                        }elseif($_GET["marketing"] == "seo"){
                                            
                                            echo"<h2>OTIMIZAÇÃO DE SITE SEO</h2>";
                                            $b2 = 'disabled active';
                                            
                                        }elseif($_GET["marketing"] == "links"){
                                            
                                            echo"<h2>LINKS PATROCINADOS</h2>";
                                            $b3 = 'disabled active';
                                            
                                        }elseif($_GET["marketing"] == "midias"){
                                            
                                            echo"<h2>MÍDIAS SOCIAIS</h2>";
                                            $b4 = 'disabled active';
                                            
                                        }elseif($_GET["marketing"] == "email"){
                                            
                                            echo"<h2>E-MAIL MARKETING</h2>";
                                            $b5 = 'disabled active';
                            ...
                            <div class="w-100"></div>
                            <div class="col block">
                                <a href="http://nivelk.com.br/marketing.digital.php?marketing=mdp" class="btn btn-outline-primary btn-block btn-lg <?php echo $b1;?>" role="button" aria-pressed="true">
                                    MDP
                                </a>
                            </div>
                            <div class="col block">
                                <a href="http://nivelk.com.br/marketing.digital.php?marketing=seo" class="btn btn-outline-primary btn-block btn-lg  <?php echo $b2; ?>" role="button" aria-pressed="true">
                                    OTIMIZAÇÃO DE SITE SEO
                                </a>
                            </div>
                            <div class="col block">
                                <a href="http://nivelk.com.br/marketing.digital.php?marketing=links" class="btn btn-outline-primary btn-block btn-lg  <?php echo $b3; ?>" role="button" aria-pressed="true">
                                    LINKS PATROCINADOS
                                </a>
                            </div>
                            <div class="w-100"></div>
                            <div class="col block">
                                <a href="http://nivelk.com.br/marketing.digital.php?marketing=midias" class="btn btn-outline-primary btn-block btn-lg  <?php echo $b4; ?>" role="button" aria-pressed="true">
                                    MÍDIAS SOCIAIS
                                </a>
                            </div>
                            <div class="col block">
                                <a href="http://nivelk.com.br/marketing.digital.php?marketing=email" class="btn btn-outline-primary btn-block btn-lg  <?php echo $b5; ?>" role="button" aria-pressed="true">
                                    E-MAIL MARKETING
                                </a>
                            </div>
                            <div class="col"></div>
