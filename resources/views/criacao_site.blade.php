...
@section('title','Criação de Site | Nivelk')
@section('style')
    ...
    <div class="Screen screen1">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="w-100"></div>
                            <div class="col block">
                                <a href="http://nivelk.com.br/criacao.site.php?criacao=site" class="btn btn-outline-primary btn-block btn-lg disabled active" role="button" aria-pressed="true">
                                    CRIAÇÃO DE SITE
                                </a>
                            </div>
                            <div class="col block">
