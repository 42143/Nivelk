    ...
    <div class="Screen screen1">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col block">
                                <a href="http://nivelk.com.br/identidade.visual.php?identidade=visual" class="btn btn-outline-primary btn-block btn-lg disabled active" role="button" aria-pressed="true">
                                    IDENTIDADE VISUAL
                                </a>
                            </div>
                            <div class="col block">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col intro">
                                        <div class="row">
                                            <div class="col"></div>
                                            <div class="col">
                                                <img src="img/identidade-visual.png" alt="identidade visual logotipo"/>
                                            </div>
                                            <div class="col"></div>
                                        </div>    
                                    </div>
